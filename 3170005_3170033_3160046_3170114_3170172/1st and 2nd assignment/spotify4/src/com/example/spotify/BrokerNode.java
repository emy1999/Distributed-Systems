...
public class BrokerNode extends Thread implements Broker,Serializable {
    ...
    public  class MyThread extends Thread implements Serializable{
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    String artist = in.readUTF(); //receive artist from consumer
    ...
    public static void main(String args[]) {
        ...
        //BrokerNode b = new BrokerNode("192.168.1.9", 7654);
        //BrokerNode b = new BrokerNode("192.168.1.9", 8765);
        BrokerNode b = new BrokerNode("192.168.1.9", 9876);
        b.init();
